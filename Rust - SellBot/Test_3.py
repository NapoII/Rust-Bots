...
write_config(config_dir, "Telegramm", "Telegramm_token", str(Token))
...
write_config(config_dir, "Telegramm", "chat_Id", str(Chat_ID))
write_config(config_dir, "Telegramm", "Bot_aktiv", "True")
